...
public class ProducerConsumer {
    ...
    public static class PC {
        ...
        // Create a list shared by producer and consumer with a size of 2
        ...
        public void produce() throws InterruptedException {
            ...
            while (true) {
                synchronized (this) {
                    ...
                    System.out.println("Producer produced-" + valueProduced);

                    // to insert the jobs in the list
                    list.add(valueProduced++);

                    // notifies the consumer thread that  now it can start consuming
                    notify();

                    // makes the working of program easier  to understand (slows program)
                    Thread.sleep(1000);
                }
            }
        }
        ...
        public void consume() throws InterruptedException {
            while (true) {
                synchronized (this) {
                    ...
                    int valueToConsume = list.removeFirst();
                    ...
                    // and sleep (actually optional - but the program is slower to follow)
                    Thread.sleep(1000);
                }
            }
        }
