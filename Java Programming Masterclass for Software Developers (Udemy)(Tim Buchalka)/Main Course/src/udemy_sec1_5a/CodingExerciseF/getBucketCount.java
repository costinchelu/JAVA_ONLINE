package udemy_sec1_5a.CodingExerciseF;

/*
Bob is a wall painter and he needs your help.
You have to write a program that helps Bob calculate how many buckets
of paint he needs to buy before going to work.
...
The method needs to return a value of type int that represents
...
This method needs to return a value of type int that represents the number
...
to 0 or if extraBuckets is less than 0, the method needs to return -1
...
(double) then convert it into an int before returning the value from the methods.
*/
...
public class getBucketCount {
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets)
    {
        ...
        int bucketsNeeded = getBucketCount(area, areaPerBucket);
