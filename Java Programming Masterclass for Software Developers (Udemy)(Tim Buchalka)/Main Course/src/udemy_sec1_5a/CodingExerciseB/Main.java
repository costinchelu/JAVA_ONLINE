package udemy_sec1_5a.CodingExerciseB;
...
public class Main
{
    ...
    {
        int an = 1960;
        if (LeapYear.isLeapYear(an) == false) System.out.println
                ("Anul " + an + " are 365 de zile.");
        if (LeapYear.isLeapYear(an) == true) System.out.println
                ("Anul " + an + " are 366 de zile (bisect).");
    }
}
