package udemy_sec1_5a.CodingExerciseE;
...
seconds passed to this method and return that value as string in format XXh YYm ZZs where XX represents a
...
public class Main
{
    ...
    {
        System.out.println(Duration.getDurationString(5, 20));
        System.out.println(Duration.getDurationString(125, 35));
        System.out.println(Duration.getDurationString(2500));
        System.out.println(Duration.getDurationString(5678));
    }
}
