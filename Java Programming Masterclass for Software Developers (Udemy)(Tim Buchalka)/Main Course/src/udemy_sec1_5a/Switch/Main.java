...
public class Main
{
    ...
    public static void main(String[] args)
    {
        ...
        switch(month.toLowerCase())				// ca sa nu cautăm pentru toate cazurile, se va face conversia in lowercase
        {
            case "january":							// testăm pentru lowercase
            ...
            case "february":
                ...
                break;
            default:
                System.out.println("Default case (optional)");
                break;
        }
