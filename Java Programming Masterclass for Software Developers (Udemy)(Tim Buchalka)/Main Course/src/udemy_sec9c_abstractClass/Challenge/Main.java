...
public class Main {
    public static void main(String[] args) {
        ...
        for (String s : data) {
            ...
            //Canberra is written in two places in the string but it will be added only once
        }
        ...
        list.removeItem(new Node("Tokyo"));
        list.removeItem(new Node("Perth"));
        list.removeItem(new Node("Cologne"));
        list.traverse(list.getRoot());
        ...
        System.out.println("-----------------------removing-----");
        tree.removeItem(new Node("Tokyo"));
