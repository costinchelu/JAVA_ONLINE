...
public class Challenges {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(challenge4.replaceAll("\\s", "_"));  // more broader solution
        ...
        while(matcher10.find()) {
            System.out.println("Occurrence: start = "
                    + matcher10.start(1)
                    + " end = "
                    + (matcher10.end(1) - 1));
        }
        ...
        // ? in this case means that we can have 0 or 1 occurrences of (-\d{4}) group
