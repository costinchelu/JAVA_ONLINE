...
/* for the time being, we only need to export to text
 so we have 2 overwritten methods that just throw exceptions.

 To avoid problems, we will split ExportableDocument interface in 3 new interfaces and remove ExportableDocument interface
