package java_techie_streamapi.optionals;

import java_techie_streamapi.practical.map_example.Customer;
import java_techie_streamapi.practical.map_example.CustomerDatabase;
...
public class OptionalDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            Customer c = getCustomerByEmailId("pqr");
